...
.---------------------------------------------------------------------------.
|  Software: mmsRESTlibraryURLEnc - PHP MMS REST client class                  |
|   Version: 1.0                                                            |
|   Contact:                                                                |
|      Info:                                                                |
|   Support:                                                                |
...
/**
 * mmsRESTlibraryURLEnc - PHP MMS REST client class
 * @author Jesús Macias Portela
 * @version 1.0
 */
 ...
 */
    ...
    */
            ...
            $contentXML=$this->sendmmsURLEncBody($address,$receiptRequest,$senderId,$subject,$priority,$charging);
...
/**
 * Compound body URLEnc of operation sendMMS
 *  
 ...
 */
    ...
    private function sendmmsURLEncBody ($address,$receiptRequest,$senderId,$subject,$priority,$charging){
    ...
    //if ($senderName!=NULL) $body=$body."senderName=".urlencode($senderName)."&";
    ...
    if ($subject!=NULL) $body=$body."subject=".urlencode($subject)."&";

    if ($priority!=NULL) $body=$body."priority=".urlencode($priority)."&";
    ...
    */
      private function AttachAll($XML=null) {
        ...
        $mime[] = sprintf("Content-Type: application/x-www-form-urlencoded%s",$this->LE);
