<?php
/*~ mmsRESTlibraryXML.php
.---------------------------------------------------------------------------.
|  Software: mmsRESTlibraryXML - PHP MMS REST client class                  |
|   Version: 1.0                                                            |
|   Contact:                                                                |
|      Info:                                                                |
|   Support:                                                                |
...
/**
 * mmsRESTlibraryXML - PHP MMS REST client class
 * @author Jesús Macias Portela
 * @version 1.0
 */
 ...
 */
    ...
    */
            ...
            $contentXML=$this->sendmmsXMLBody($address,$receiptRequest,$senderId,$subject,$priority,$charging);
...
/**
 * Compound body XML of operation sendMMS
 *  
 ...
 */
    ...
    private function sendmmsXMLBody ($address,$receiptRequest,$senderId,$subject,$priority,$charging){
    $iterator=0;
    $XMLbody='<?xml version="1.0" encoding="UTF-8" standalone="no"?><tns:message xmlns:parlayx_common_xsd="http://www.csapi.org/schema/parlayx/common/v3_1" xmlns:tns="http://www.telefonica.com/UNICA/mms_bodies/v0_1_1_LITMUS_LATAM_03102009" xmlns:tns1="http://www.telefonica.com/UNICA/mms_types/v0_1_1_LITMUS_LATAM_03102009" xmlns:tns2="http://www.telefonica.com/UNICA_CommonTypes/v0_1">';
//xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.telefonica.com/UNICA/mms_bodies/v0_1_1 UNICA_API_mms_bodies_REST_v0_1_1.xsd" 
    if (isset($address[0])){
        $iterator=0;
    ...
    //if (is_string($message)) $body=$body."message=".urlencode($message)."&";
        ...
        if ($subject!=NULL)  $XMLbody.='<tns1:subject>'.$subject.'</tns1:subject>';
        if ($priority!=NULL)  $XMLbody.='<tns1:priority>'.$priority.'</tns1:priority>';
    ...
    */
      private function AttachAll($XML=null) {
        ...
        $mime[] = sprintf("Content-Type: application/xml%s",$this->LE);
