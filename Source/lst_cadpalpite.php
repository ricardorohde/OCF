...
//		    echo ('         <tr> <td colspan=2>Para registrar seu palpite você precisa se inscrever no campeonato.</td> </tr>')."\n";
		...
		// Se for copa do mundo 2006 e data e hora atual for > 08/06/2006 as 23:59 não permite mais o palpite
		  if ($row['campeonato'] == 4) {
          ...
          $dtini = mktime(date("H",strtotime($row['datahora'])), //Hora
		   ...
		   if ($dif > 0 && $row['campeonato'] == 3) {
		    ...
		    echo ('         <tr> <td><br></td> </tr>')."\n";
/*			echo ('         <tr> <td colspan=4>* Os palpites podem ser registrados ou alterados até 15 minutos antes do início de cada partida</td></tr>')."\n";*/
	}
