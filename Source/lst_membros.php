...
<?php require_once($_SESSION['DOCROOT']."/classes/class.usuario.php"); ?>
 ...
 <span class="titusr">Membros</span>

 <?php include("traco.php"); ?>
  <table  id="tabform" style="width:600px;">
  <tr  class="cabec"><td>Membro</td><td>Desde</td><td>Cidade</td><td align=center>UF</td><td align=center>Ano</td><td>Fone</td><td>Celular</td><td></td></tr>
  <?php
