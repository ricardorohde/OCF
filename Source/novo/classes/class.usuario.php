  ...
  if ($userid == 0) {
  		$this->Existe = "N";
		   ...
		   $sql = sprintf("select
					   ...
					   aprovado,
					   dtaprovacao,
					   AES_DECRYPT(encpwd,'%s') encpwd
					   from
		               cad_usuario
		               where userid = %d",$this->getEncKey(),$userid);
			...
			$this->EncPwd           = $db_user->getValue('encpwd');
    ...
    function getEncPwd() {   return $this->EncPwd;}
    private function getEncKey() {   return $this->EncKey;}
